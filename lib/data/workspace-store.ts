...
const seedMindMaps: MindMap[] = [
  {
    ...
    nodes: [
      { id: "n1", x: 400, y: 200, label: "PhD Thesis", color: "#3b82f6", radius: 40 },
      { id: "n2", x: 200, y: 100, label: "Paper 1:\nMetrics", color: "#22c55e", radius: 32 },
      { id: "n3", x: 200, y: 300, label: "Paper 2:\nIntervention", color: "#22c55e", radius: 32 },
      { id: "n4", x: 600, y: 100, label: "Paper 3:\nEvaluation", color: "#22c55e", radius: 32 },
      { id: "n5", x: 600, y: 300, label: "Stepped\nWedge", color: "#f59e0b", radius: 28 },
      { id: "n6", x: 400, y: 380, label: "Provenance\nChain", color: "#f59e0b", radius: 28 },
      { id: "n7", x: 100, y: 200, label: "TTDC /\nTTGP", color: "#ef4444", radius: 26 },
    ],
    edges: [
      { id: "e1", from: "n1", to: "n2" },
      { id: "e2", from: "n1", to: "n3" },
